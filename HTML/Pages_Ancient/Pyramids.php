...
<body>
  ...
  <main class="hero">
    <div class="content">
      <h1 class="reveal">
        Uncover the <em>Mysteries</em> of the Egyptian Pyramids with
        <span class="brand">NileTreasures</span>
      </h1>
      <p class="reveal">
        Embark on a journey through time and discover the secrets of the
        pyramids, ancient monuments that stand as testaments to human ingenuity
        and the rich history of Egypt. Explore their architectural marvels and
        cultural significance with us.
      </p>
      <div class="stats">
        <div class="stat-box reveal">
          <h2 class="counter" data-target="138">0</h2>
          <p>
            Pyramids Discovered, each holding unique historical significance.
          </p>
        </div>
        <div class="stat-box reveal">
          <h2 class="counter" data-target="4500">0</h2>
          <p>
            Years of history etched in stone, waiting to be explored and
            understood.
          </p>
        </div>
      </div>
    ...
    <div class="image">
      <img src="../../Image/your-image.jpeg" alt="Egyptian Pyramids" />
    </div>
  </main>
  ...
  <main class="booking-form">
    ...
    <form action="../../PHP/form_pages.php" method="POST">
      ...
      <div class="form-group">
        ...
        <input type="text" name="location" id="location" value="Pyramids" readonly />
      </div>
